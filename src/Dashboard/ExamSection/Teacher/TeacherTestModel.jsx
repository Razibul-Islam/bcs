...
const TeacherTestModel = () => {
  ...
  const handleCreateExam = (e) => {
    ...
    // console.log(data);
    fetch("https://bcspioneer.vercel.app/teacher-preparation-exam", {
      method: "POST",
      headers: {
  ...
  return (
    <div className="p-5">
      <h1 className="text-center my-5">Teacher</h1>
      <div className="flex justify-between items-center">
        <div className="flex gap-5">
          ...
          <Link to="/dashboard/teacherRecruitment/exam-list" className="bg-pink-500 px-5 py-1 text-white rounded-sm shadow-lg">
            Exam List
          </Link>
          <button
      ...
      <section className="flex justify-between gap-5">
        <div className="w-1/2 border-r mt-10 shadow-lg p-5">
          <div>
            <h2 className="text-center">Teacher Question</h2>
