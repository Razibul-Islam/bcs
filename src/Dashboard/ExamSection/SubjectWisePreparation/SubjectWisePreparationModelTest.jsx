...
const SubjectWisePreparationModelTest = () => {
  ...
  const handleCreateExam = (e) => {
    ...
    // console.log(data);
    fetch("https://bcspioneer.vercel.app/subject-wise-exam", {
      method: "POST",
      headers: {
  ...
  return (
    <div className="p-5">
      <h1 className="text-center my-5">Subject Wise Preparation</h1>
      <div className="flex justify-between items-center">
        <div className="flex gap-5">
          ...
          <Link to="/dashboard/subject-wise/exam-list" className="bg-pink-500 px-5 py-1 text-white rounded-sm shadow-lg">
            Exam List
          </Link>
          <button
      ...
      <section className="flex justify-between gap-5">
        <div className="w-1/2 border-r mt-10 shadow-lg p-5">
          <div>
            <h2 className="text-center">Subject Wise Preparation Question</h2>
