...
const MentalSkills = () => {
  const data = [
    {
      title: "ভাষাগত যৌক্তিক বিচার (Verbal Reasoning)",
      _id: "01",
    },
    {
    ...
    {
      title: "বানান ও ভাষা (spelling and language)",
      _id: "03",
    },
    {
      title: "যান্ত্রিক দক্ষতা (Mechanical Reasoning)",
      _id: "04",
    },
    {
      title: "স্থানাঙ্ক সম্পর্ক (Space Relation)",
      _id: "05",
    },
    {
      title: "সংখ্যাগত ক্ষমতা (Numerical Ability)",
      _id: "06",
    },
  ];
  return (
        ...
        {data.map((item, i) => (
          ...
          >
            ...
            <div className="flex space-x-3 items-center text-xs">
              <Link
                to={`/jobsulationtopic/mentalSkill/${item.title}`}
