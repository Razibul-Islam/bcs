...
const JobSolution = () => {
  ...
  return (
    <div>
      <h1 className='my-5 text-center '>জব সল্যুশন</h1>
      <div>
        <div>
          <div className="w-[300px]  h-[200px]  mx-auto mt-10 relative flex items-center justify-center">
            ...
            <Link to="/jobsolution/merit" className="absolute text-white  w-24 text-center py-2 bg-[#9b59b6]  rounded-3xl shadow-md bottom-0 right-0">
              মেরিট লিস্ট
            </Link>
