...
const BCSForNewModelTestArchive = () => {
  ...
  return (
    <div>
      <h1 className="my-5 text-center">BCS For New Archive</h1>
        ...
        {archive.map((question) => {
          return (
            <div className="text-center mt-5">
              <Link
                to={`/bcsfornew-archive/${question._id}`}
...
export default BCSForNewModelTestArchive;
