            ...
            result.map(res => {
                return(
                    <div className='text-center p-5 border border-dashed '>
                       <p>{res.examDate}</p>
                        <p>Free Weakly Model Test </p>
                        <Link to={`/free-weakly-meritlist-single/${res.examDate}`}  className='bg-teal-500 text-white px-5 rounded-3xl my-2'>view</Link>
                    </div>
                )
            })
           }
...
export default FreeWeaklyMeritList;