    ...
    return (
        <div className='md:p-5'>
            <div className='max-w-xl mx-auto '>
                <div className='grid grid-cols-2 gap-2'>
                    ...
                    <div className='bg-teal-200 py-4 text-center'>
                        ...
                        <span className='flex justify-center items-center gap-3'><CheckCircleIcon className='text-green-500' />{pashed.length}</span>
                    </div>
                </div>
            </div>
            <div className='max-w-xl mx-auto my-2'>
                <div className='grid grid-cols-2 gap-2'>
                    <div className='bg-pink-200 py-4 text-center'>
                        <p>কাট মার্ক</p>
                        <span className='flex justify-center items-center gap-3'><PeopleIcon className='text-teal-600'></PeopleIcon>{result.cutsark}</span>
                    </div>
                    <div className='bg-pink-100 py-4 text-center'>
                        <p>আপনার মার্কস</p>
                        <span className='flex justify-center items-center gap-3'><CheckCircleIcon className='text-green-500' />{result.totalCorrectAns}</span>
                    </div>
                </div>
            </div>
            <div className='max-w-xl mx-auto '>
                <div className=''>
                    <div className='bg-orange-100 py-4 text-center'>
                        ...
                        <span className='flex justify-center items-center gap-3'><PeopleIcon className='text-teal-600'></PeopleIcon>{targetIndex + 1}</span>
                    </div>
            ...
            <div className='text-center mt-10'>
                ...
                <br />
                <br />
                <Link className='bg-teal-500 px-5 text-white my-2 rounded-sm'>মেধা তালিকা দেখুন</Link>
            </div>
