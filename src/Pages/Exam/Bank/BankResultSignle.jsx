...
const BankResultSignle = () => {
  ...
  useEffect(() => {
    fetch(`http://localhost:5000/get-single-bank-preparation-result?_id=${_id}`)
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(
      `http://localhost:5000/bank-preparation-merit-list?examDate=${result.examDate}`
    )
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(
      `http://localhost:5000/bank-preparation-passhed?examDate=${result.examDate}&cuts=${result.cutsark}`
    )
      .then((res) => res.json())
