...
const BankResultSignle = () => {
  ...
  useEffect(() => {
    fetch(`https://bcspioneer.vercel.app/get-single-bank-preparation-result?_id=${_id}`)
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(
      `https://bcspioneer.vercel.app/bank-preparation-merit-list?examDate=${result.examDate}`
    )
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(
      `https://bcspioneer.vercel.app/bank-preparation-passhed?examDate=${result.examDate}&cuts=${result.cutsark}`
    )
      .then((res) => res.json())
...
export default BankResultSignle;
