...
const Video = () => {
  return (
    <div className="p-5">
      <h1 className="text-center my-4 text-lg text-teal-500">ভিডিও ক্লাস</h1>
      <div className="my-20  max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-3 gap-5">
        <Link
          to="/video/videoroutine"
