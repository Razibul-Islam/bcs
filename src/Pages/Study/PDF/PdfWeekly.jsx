...
const PdfWeekly = () => {
  ...
  useEffect(() => {
    fetch("https://bcspioneer.vercel.app/get-study-pdf?section=Weekly Bulletin")
      .then((res) => res.json())
  ...
  return (
    <div className="p-5">
      <h1 className="text-center my-4 text-lg">Weekly Bulletin</h1>
