...
const PdfRecent = () => {
  ...
  useEffect(() => {
    fetch("https://bcspioneer.vercel.app/get-study-pdf?section=সাম্প্রতিক সমাচার")
      .then((res) => res.json())
  ...
  return (
    <div className="p-5">
      <h1 className="text-center my-4 text-lg">সাম্প্রতিক সমাচার</h1>
