...
const FreeWeaklyModelTestForExprienced = () => {
  return (
    <div className="p-5">
      <h1 className="text-center my-4">ফ্রি সাপ্তাহিক মডেল টেস্ট</h1>
      <button className="bg-[#ffae0b] text-center px-5 py-1 rounded-3xl w-60 mx-auto block text-white">
        Start Live Exam{" "}
      </button>
...
export default FreeWeaklyModelTestForExprienced;
