...
const CentralResult = () => {
  ...
  return (
    <div className="mt-5">
      <h1 className="text-center text-2xl">Central Result</h1>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4">
        <div className="p-2 shadow-md">
          <h1 className="text-center mb-4 text-xl">Aug 05, 2023</h1>
          <h1 className="text-center mb-4 text-xl">ব্যাংক নিয়োগ প্রস্তুতি</h1>
          <p className="mb-2">
            [বাংলাদেশ ব্যাংক সহকারী পরিচালক নিয়োগ প্রস্তুতি - ২০২৩]
          </p>
          <p className="mb-2">বিষয় : সাধারণ জ্ঞান</p>
          <p>
            <span>টপিক:</span>
            <br />
            <ul className="list-decimal list-inside">
              <li>Recent Affairs (Bangladesh and International Issues)</li>
            </ul>
          </p>
        </div>
      </div>
