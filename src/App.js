    ...
    <div className="bg-banner ">
      ...
      <Routes>
        ...
        <Route path="/dashboard" element={<RequireAdmin>
          ...
          <Route path="/dashboard/past-bcs-question" element={<BCSPastQuestion />} ></Route>
          <Route path="/dashboard/read-topic-add" element={<TopicForReadTopic />} ></Route>
          <Route path="/dashboard/free-weakly-modeltest" element={<DFreeWeaklyModelTest />} />
          <Route path="/dashboard/free-weakly-modeltest/rutin" element={<FreeModelRutin />} />
          <Route path="/dashboard/free-weakly-modeltest/exam-list" element={<FreeWeaklyExamList />} />
          <Route path="/dashboard/free-weakly-modeltest" element={<DFreeWeaklyModelTest />} />
          <Route path="/dashboard/free-weakly-modeltest/rutin" element={<FreeModelRutin />} />
          <Route path="/dashboard/bcsForNew/routine" element={<BcsForNewRoutine />} />
          <Route path="/dashboard/bcsForNew" element={<BcsForNewRoutineModelTest />} />
